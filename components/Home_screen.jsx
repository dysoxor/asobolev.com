      ...
      <div className='home-text-contact-container'>
        <div className='home-text-container'>
          ...
          <div className='home-name'>
            <div className='typing-home-name'><FontAwesomeIcon icon={faChevronRight} style={{fontSize: '74px', fontWeight:'100' }} /> <span className='home-logo'>I&apos;m <span className='home-left-logo'>A</span><span className='home-right-logo'>A</span>ndrey</span></div>
          </div>
