      ...
      <div className='home-text-contact-container'>
        <div className='home-text-container'>
          ...
          <div className='home-name'>
            <div className='typing-home-name'><FontAwesomeIcon icon={faChevronRight} style={{fontSize: '74px', fontWeight:'100' }} /> <span className='home-logo'>I&apos;m <Image src={logo_web} alt='website logo' width={70} height={70} style={{marginBottom:'-0.1em',marginRight:'-0.08em'}}/>ndrey</span></div>
          </div>
